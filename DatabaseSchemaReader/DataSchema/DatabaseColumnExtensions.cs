...
namespace DatabaseSchemaReader.DataSchema
{
	...
	public static class DatabaseColumnExtensions
	{
		...
		/// <summary>
		/// Tries cast <paramref name="column"/> into <see cref="DatabaseIndexedColumn"/> or create new instance of <see cref="DatabaseIndexedColumn"/> with copy of all data
		/// </summary>
		/// <param name="column"></param>
		/// <returns></returns>
		public static DatabaseIndexedColumn ToIndexedColumn(this DatabaseColumn column)
		{
			if (column == null)
			{
			...
			if (column is DatabaseIndexedColumn indexedColumn)
			{
				return indexedColumn;
			}

			return new DatabaseIndexedColumn(column);
		}
	}
}
